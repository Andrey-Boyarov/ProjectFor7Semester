...
I1, K1, hx1, ht1, x1, t1, u1 = calculate(10, 6000)
I2, K2, hx2, ht2, x2, t2, u2 = calculate(10 * 2, 6000)
I3, K3, hx3, ht3, x3, t3, u3 = calculate(10 * 4, 6000)
...
I1, K1, hx1, ht1, x1, t1, u1 = calculate(5, 4000)
I2, K2, hx2, ht2, x2, t2, u2 = calculate(5 * 2, 4000)
I3, K3, hx3, ht3, x3, t3, u3 = calculate(5 * 4, 4000)
a1 = np.max(np.absolute(u1-u2[::2]))
a2 = np.max(np.absolute(u2-u3[::2]))
print("3.1) " + str(a1))
print("3.2) " + str(a2))
...
#np.max(np.absolute(U1-U2[::2]))
I1, K1, hx1, ht1, x1, t1, u1 = calculate(20, 600)
I2, K2, hx2, ht2, x2, t2, u2 = calculate(20, 600 * 2)
I3, K3, hx3, ht3, x3, t3, u3 = calculate(20, 600 * 4)
a1 = np.max(np.absolute(u1-u2[:, ::2]))
a2 = np.max(np.absolute(u2-u3[:, ::2]))
